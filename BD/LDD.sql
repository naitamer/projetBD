...
(4, 'robe', NULL, 'validated', 3, 2),
(5, 'chaussure', 'tout a fait nouveau', 34.00, 'validated', 4, 2),
(6, 'chaussure', 'limited edition', 33.00, 'waiting', 5, 2),
(7, 'poussette', 'poussette blanche', 'validated', 8, 3),
(8, 'vase antique', 'vase antique rouge', 'waiting', 1, 1),
...
(12, 'chandail', 'chandail pour le bebe, 6 mois', 'validated', 19, 3),
(13, 'chapeau bleu', 'usagé, bleu, cute', 'estimated', 38, 3),
(14, 'chaise', 'chaise pour outdoor', 'refused', 32, 6),
...
(22, 'pantalon', 'levis jean', 'validated', 56, 2),
(23, 'pantalon', 'jean noir', 'validated', 55, 2),
...
(38, 'jeu de societe', 10.00, 'blocus game', 'estimated', 66, 5),
(39, 'jeu de societe', 10.00, 'opération game', 'waiting', 65, 5),
(40, 'jeu de societe', 15.00, 'connect 4 game', 'waiting', 71, 5),
