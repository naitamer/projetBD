...
public class InterfaceAnnonceur {
	...
	InterfaceAnnonceur(){  
        ...
        f.setVisible(true);            //Afficher l'objet graphique. 
	     ...
	     JButton JbAjoutter =new JButton("Ajouter un annonce");      //Créer un bouton.
	     ...
	     JbSoumetttre.setBounds(355, 700, 200, 50);                   //Définir la taille du bouton.
	     ...
	     JLabel labelSousCategorie=new JLabel("Sous_Catégorie : ");       //créer les Labels.
	     labelSousCategorie.setBounds(15,10, 200, 450); 
	     labelSousCategorie.setFont(new Font("Serif", Font.BOLD, 20));     //Définir le Font des labels.
	     ...
	     tTitreDeProduit.setBounds(170,40,250 , 40);
       ...
       //  listCategorie.setBounds(200, 200, 600, 80);       //Définir les tailles et les places des listes.
        // listSousCategorie.setBounds(200, 300, 600, 80);
         ...
         JScrollPane scrolCategorie= new JScrollPane();    //Définir un ScrollPan.
         f.add(scrolCategorie);                             //Ajouter un ScrollPan  au JFram.
         scrolCategorie.setBounds(190, 200, 600, 80);      //Définir la place du Scrollpan.
         scrolCategorie.setSize(500,80);
         scrolCategorie.setVisible(true);                   //Afficher ScrollPan.
         scrolCategorie.setViewportView(listCategorie); 
         
         JScrollPane scrolSousCategorie= new JScrollPane();    //Définir un ScrollPan.
         f.add(scrolSousCategorie);                             //Ajouter un ScrollPan  au JFram.
         scrolSousCategorie.setBounds(190, 300, 600, 80);      //Définir la place du Scrollpan.
         scrolSousCategorie.setSize(500,80);
         scrolSousCategorie.setVisible(true);                   //Afficher ScrollPan.
         scrolSousCategorie.setViewportView(listSousCategorie); 
